...
jogador_bp = Blueprint('jogador', __name__, url_prefix='/jogadores',template_folder="../../templates/")

@jogador_bp.route("/listagem")
@login_required
def listagem():
...
@jogador_bp.route('/cadastro', methods=['GET', 'POST'])
@login_required
...
@jogador_bp.route("/<int:jogador_id>/alterar-situacao", methods=['GET', 'POST'])
@login_required
